   ...
   <div className="px-6 mx-auto sm:px-8 lg:px-12 max-w-7xl">
     <div className="w-full lg:w-2/3 xl:w-1/2">
         ...
         <p className="mt-6 tracking-tighter text-black">
             <span className="font-sans font-normal text-7xl">The NEW FUTURE OF ARCHITECTURE</span><br />
             <span className="font-serif italic font-normal text-8xl">THE BEST DESIGNIGNERS AND PLANNERS</span>
         </p>
