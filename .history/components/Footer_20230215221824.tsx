...
const Footer = () => {
    return (
    <footer className="mt-3 bg-black">
        <div className="mx-auto max-w-screen-xl px-6 pt-16 sm:px-8">
          <div className="grid grid-cols-1 gap-y-6 gap-x-6 md:!grid-cols-6 md:gap-8 xs:grid-cols-2">
            <div className="mb-4  flex flex-col xs:col-span-2">
              <span className="text-xl font-bold capitalize text-white">ARCHIES STUDIO</span>
              <p className="mt-4 max-w-screen-xs text-sm font-semibold text-white">
                ...
                <div key={title}>
                  ...
                  <ul className="mt-4 space-y-2">
                    {items.map((item) => (
                      <li key={item.title}>
                        <Link href={item.href}>
                          <a className="transition-all duration-150 hover:text-indigo-800 hover:underline text-white">
                            {item.title}
                          </a>
                        </Link>
                      </li>
          ...
          <div
            id="footer-copyright"
            className="mt-2 bg-black border-t border-slate-200 py-4 dark:border-slate-600"
          >
            <p className="text-center text-sm dark:text-gray-300">
              Copyright © 2023{" "}
              <a
                href="https://github.com/miadv"
                className="font-semibold hover:text-indigo-800 hover:underline text-white"
              >
                Brian Rimi
              </a>
            </p>
