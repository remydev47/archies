  ...
  <div className="relative">  
   <div className="px-6 mx-auto sm:px-8 lg:px-12 max-w-5xl">
     <div className="w-full lg:w-2/3 xl:w-1/2">
         ...
         <p className="mt-12 font-sans text-base font-bold text-white text-opacity-70">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Eu penatibus pellentesque dolor consequat ligula egestas massa gravida. Porttitor venenatis enim praesent.</p>
