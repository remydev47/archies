  ...
  return (
    ...
    <div className="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8">
        <div className="grid items-center grid-cols-1 gap-y-6 md:grid-cols-2 md:gap-x-20">
            <div className="">
                <h1 className='text-xl text-gray-500 text-center'>WELCOME TO OUR AGENCY</h1>
                ...
                <h2 className='text-gray-500 font-serif italic '>WE ARE BUILDING EVERTHING YOU ALWAYS WANTED IN ARCHITECT</h2>
